                        ...
                        <form action="{{url('/updaterecipe/'.$recipe->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="recipe_name" id="recipe_name" value="{{$recipe->recipe_name}}"  class="form-control"> 
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="category" name="category" value="{{$recipe->category}}" class="form-control">
                                </div>

                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="">Image</label>
                                        <input type="file" name="image" id="image" value="{{$recipe->image}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="">Cooking Time</label>
                                        <input type="text" name="cookingtime" id="cookingtime"  value="{{$recipe->cookingtime}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="">Video Link</label>
                                        <input type="text" name="video" id="video" value="{{$recipe->video}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="">Nutritional Values</label>
                                        <input type="text" name="nutrition" id="nutrition" value="{{$recipe->nutrition}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="">External Link</label>
                                        <input type="text" name="link" id="link" value="{{$recipe->link}}" class="form-control">
                                    </div>
                                </div>
                            </div>
{{-- 
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="recipe_description" id="recipe_description" cols="30" rows="4" value="{{$recipe->recipe_description}}" class="form-control"></textarea>
                            </div>
