...
<body>
    ...
    <section class="bg-image " style="background-image:url('images/lowgenic.jpg');">
        <div class="overlayer pt-5 pb-5">
            <div class="container">
                <div class="testbox text-center">
                    <h2 class="text-center"php >Low Fat Diet</h2>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('lowsinglepage',[$item->id])}}">Read More</a>
                    </td>
